      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6 md:p-10 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* SCAN INFO */}
            <div className="bg-white dark:bg-[#11161D] border border-gray-200 dark:border-white/10 rounded-2xl p-6 text-sm space-y-4">
              <div>
              ...
              <div>
                ...
                <p className="text-teal-500 dark:text-teal-400">{scan.name}</p>
              </div>

              <div>
                <p className="text-gray-500 dark:text-gray-400">ENDPOINTS</p>
                <p className="font-semibold">{scan.endpoints || 0}</p>
              </div>
            </div>

            {/* TOTAL ISSUES */}
            <div className="bg-white dark:bg-[#11161D] border border-gray-200 dark:border-white/10 rounded-2xl p-6 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-[#11161D] border border-gray-200 dark:border-white/10 rounded-2xl p-6 space-y-4 text-sm">
              ...
              {scan.remediation && (
                <div className="pt-4 text-xs space-y-2 text-gray-500 dark:text-gray-400">
...
function SeverityCard({ title, count, color }) {
  ...
  return (
    <div className="bg-white dark:bg-[#11161D] border border-gray-200 dark:border-white/10 rounded-2xl p-5">
...
function InfoBox({ label, value }) {
  return (
    <div className="bg-gray-100 dark:bg-black/30 border border-gray-200 dark:border-white/10 rounded-lg p-3">
